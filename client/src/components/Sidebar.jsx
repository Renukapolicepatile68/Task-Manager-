...
const Sidebar = () => {
  ...
  // For non-admin users, show Dashboard, Tasks, Completed, In Progress, To Do, and Trash
  // For admin users, show all links
  const sidebarLinks = user?.isAdmin ? linkData : [...linkData.slice(0, 5), linkData[7]];
