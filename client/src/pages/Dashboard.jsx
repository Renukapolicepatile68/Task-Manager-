...
const Card = ({ label, count, bg, icon, to }) => {
  const cardContent = (
    <div className='w-full h-32 bg-white p-5 shadow-md rounded-md flex items-center justify-between hover:shadow-lg transition-shadow duration-200'>
  ...
  return (
    <div className='h-full py-4'>
      <>
        ...
        <div className='w-full grid gap-6 xl:grid-cols-[2fr_1fr]'>
